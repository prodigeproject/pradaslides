(() => {
  ...
  window.PRADA_DECK = {
    meta: { title: 'PradaSlides · Benchmark', stageLabel: 'PRADASLIDES / HTML BENCHMARK', status: 'final', storageKey: 'pradaslides:public-html-benchmark', transition: 'fade' },
    design: {
      canvas: { width_px: 1600, height_px: 900 },
      typography: { display_family: 'Iowan Old Style, Palatino Linotype, Book Antiqua, Georgia, serif', body_family: 'Aptos, Inter, Arial, sans-serif', mono_family: 'Aptos Mono, SFMono-Regular, Consolas, monospace' },
      color: { accent: '#cf6c3f', positive: '#6f9988', warning: '#c79745', negative: '#b34e4e', tones: {
        light: { background: '#f4efe7', surface: '#fffaf3', text: '#24211d', muted: '#625b52', line: '#d8cec1' },
        dark: { background: '#191b19', surface: '#262a27', text: '#fffaf3', muted: '#d1c9be', line: '#515651' },
        accent: { background: '#d9ba8b', surface: '#f3e0c1', text: '#241f1a', muted: '#5d4531', line: '#b98757' },
      } },
    },
    slides,
  };
